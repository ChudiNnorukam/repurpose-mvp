---
description: Customizes Claude's response formatting and output style preferences. Use when user wants different formatting or mentions 'output format', 'response style'.
skill-version: 1.0.0
...
## Purpose
Customizes Claude's response formatting and output style preferences.
...
- Task requires output-style-setup expertise
...
Invoking output-style-setup subagent with Repurpose context...
...
*This skill enhances the built-in output-style-setup subagent with Repurpose MVP-specific knowledge and patterns.*
