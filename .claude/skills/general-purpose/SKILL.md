---
description: Fallback skill for general requests that don't match specialized skills. Handles diverse tasks, provides general assistance, and routes to other skills when appropriate.
skill-version: 1.0.0
...
## Purpose
Fallback skill for general requests that don't match specialized skills.

## When to Use

### Trigger Keywords
General fallback skill

### Typical Requests
- User mentions one of the trigger keywords
- Context matches Repurpose MVP patterns
- Task requires general-purpose expertise
...
Invoking general-purpose subagent with Repurpose context...
...
*This skill enhances the built-in general-purpose subagent with Repurpose MVP-specific knowledge and patterns.*
