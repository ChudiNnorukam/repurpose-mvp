---
description: Configures Claude Code status line display and CLI output formatting. Use when user wants to customize status display.
skill-version: 1.0.0
allowed-tools:
  - view
  - str_replace
...
## Purpose
Configures Claude Code status line display and CLI output formatting.
...
- Task requires statusline-setup expertise
...
Invoking statusline-setup subagent with Repurpose context...
...
*This skill enhances the built-in statusline-setup subagent with Repurpose MVP-specific knowledge and patterns.*
